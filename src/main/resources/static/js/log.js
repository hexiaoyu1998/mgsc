    ...
    $("#btn-login").click(function(){
        ...
        if(isEmpty(Account)){
            ...
            if(isPwdvalidate(Password))
            {
                ...
                $.post("/mgsc/user/login",datalogin,function (result){
                    if(result instanceof Object)
                    {
                        $.post("/mgsc/in/Space",result,function (result2){
        ...
        if(isEmpty(userName)||isEmpty(userEmail)||isEmpty(userPassword))
        {
            ...
            else
            {
                ...
                if(!isPwdvalidate(userPassword))
                {
                    ...
                    $.post("/mgsc/user/register",dataregister,function (result){
            ...
            if(isEmpty(vertiEmail)){
                ...
                if(isEmail(vertiEmail)){
                    $.ajax({
                        ...
                        error: function (e) {
                            alert("send verification code error");
                        }
                    })
                }
                else
