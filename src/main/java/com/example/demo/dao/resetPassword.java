    ...
    public String sendCode(String email) {
        ...
        try {
            ...
            if (userEntity != null) {
                ...
                //将验证码发送给用户
                //1. 构建邮件内容
                String subject = "MGSC of IGU Verification Code";
                String content = "Hello " + userEntity.getUserName() + ":<br/>" +
                        ...
                        "Welcome to <a href='http://www.igu-geomodeling.com/' target='_blank'>MGSC of IGU</a> !";
                //2.发送邮件
...
//            InternetAddress internetAddress = new InternetAddress(mailAddress, "MGSC of IGU", "UTF-8");
